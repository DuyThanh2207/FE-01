                ...
                <div className="row">
                  <div className="col-sm-12 col-lg-8">
                    <div className="content-text">
                      "Vẫn là vẻ bề ngoài vô cùng đơn giản với các tông màu
                      trắng, hồng làm chủ đạo nhưng lại tạo ra sức hút kỳ lạ với
                      những ai cầm trên tay sản phẩm ấy! Với công nghệ cải tiến
                      mới nhất, hảng Rohto"
                    </div>
                  </div>
                </div>
                  ...
                  <div className="about-us__content">
                    ...
                    <div className="about-us__content-introduce">
                      <p>
                        ...
                        nay tớ quay lại hâm nóng cái Blog này vào một ngày đầu
                        hè nóng oi bức, khi mà dân tình xô nhau đi tắm Free để
                        giải nhiệt.Hi, chào các nàng ... sau khá nhiều lời hứa
                        hão thì hôm nay tớ quay lại hâm nóng cái Blog này vào
                        một ngày đầu hè nóng oi bức, khi mà dân tình xô nhau đi
                        tắm Free để giải nhiệt.Hi, chào các nàng ... sau khá
                        nhiều lời hứa hão thì hôm nay tớ quay lại hâm nóng cái
                        Blog này vào một ngày đầu hè nóng oi bức, khi mà dân
              ...
              <div className="col-xs-12 col-sm-6 col-lg-4">
                <div className="details__blog">
                  ...
                  <p className="details__blog-introduce">
                    ...
                    tớ quay lại hăm nóng cái Blog này vào một ngày đầu hè nóng
